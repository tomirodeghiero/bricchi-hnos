  ...
  return (
    <div>
      ...
      <div className="mx-auto">
        <div className="flex mx-auto gap-20 max-w-5xl">
          <div className="w-1/2">
            <img src={ABOUT_01} alt="Sobre Nosotros" className="w-full" />
          </div>

          <div className="w-1/2 mt-10 px-4 lg:px-0">
            ...
            <p className="text-gray-800 text-sm mt-2">Ofrecemos las mejores soluciones en maquinaria agrícola para maximizar tu productividad y eficiencia.</p>
            <p className="text-gray-800 text-sm mt-4">Nuestro compromiso es brindar equipos de alta calidad que se adapten a las necesidades específicas de cada cliente, garantizando rendimiento y durabilidad en cada uso.</p>
            <div className="flex justify-between mt-4">
              <div className="flex justify-between items-center gap-2">
                <img src={TRACTOR} alt="Icono Maquinaria Agrícola" className="w-10 h-10" />
                <h3 className="w-40 text-green-900 font-medium leading-4">Maquinaria Agrícola Moderna</h3>
              </div>
              <div className="flex justify-between items-center gap-2">
                <img src={SPARE_PARTS} alt="Icono Maquinaria Agrícola" className="w-10 h-10" />
                <h3 className="w-40 text-green-900 font-medium leading-4">Repuestos Para El Campo</h3>
              </div>
            </div>
            ...
            <div className="max-w-5xl mx-auto mt-5">
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                {categories.map((category, index) => (
                  <div key={index} className="flex flex-col bg-gray-200 rounded-b-2xl">
                    ...
                    <h3 className="font-bold text-green-900 mt-4 text-2xl px-4">
                      {category.title}
                    </h3>
        ...
        <div className="bg-green-900 py-10">
          <div className="max-w-5xl mx-auto px-4 lg:px-0">
            ...
            <div className="max-w-5xl mx-auto mt-5 bg-green-900">
